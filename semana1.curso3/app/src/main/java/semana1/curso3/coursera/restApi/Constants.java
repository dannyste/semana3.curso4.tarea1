...
public class Constants {
    ...
    private static final String INSTAGRAM_KEY_GET_RELATIONSHIP_USER_ID = "users/{user_id}/relationship?";
    ...
    static final String INSTAGRAM_URL_GET_RELATIONSHIP_USER_ID = INSTAGRAM_KEY_GET_RELATIONSHIP_USER_ID + INSTAGRAM_KEY_ACCESS_TOKEN + INSTAGRAM_ACCESS_TOKEN;
